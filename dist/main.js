...
/* harmony import */ var _confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../confirm-modal/confirm-modal.component */ "./src/app/components/confirm-modal/confirm-modal.component.ts");
/* harmony import */ var ng2_semantic_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ng2-semantic-ui */ "./node_modules/ng2-semantic-ui/dist/public.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ModelsComponent = /** @class */ (function () {
    function ModelsComponent(ms, modalService) {
        this.ms = ms;
        this.modalService = modalService;
    }
    ModelsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ms.getModels().subscribe(function (m) {
            _this.models = m;
        });
    ...
    ModelsComponent.prototype.ngAfterViewInit = function () {
        ...
        this.ms.getModels().subscribe(function (result) {
            ...
            console.log(e);
            _this.modalService.open(new _confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmModal"]('Error', 'While retrieving the list of models: ' + e + 'Notify webmaster?', 'tiny'))
                .onApprove(function () {
...
/* harmony import */ var _importeditems_importeditems_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../importeditems/importeditems.component */ "./src/app/components/importeditems/importeditems.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UploadComponent = /** @class */ (function () {
    function UploadComponent(auth, store, http) {
        var _this = this;
        this.auth = auth;
        this.store = store;
        this.http = http;
        ...
        this.uploader.onCompleteItem = function (item) {
            ...
            if (item.file.name.endsWith('.shp')) {
                ...
                var converted = item.file.name.replace('.shp', '.json');
                _this.conversions.push(converted);
    ...
    UploadComponent.prototype.ngOnInit = function () {
        ...
        this.authSubscription = this.auth.loggedIn$
            ...
            if (loggedIn) {
                console.log('Getting locally-stored queries.');
                console.log('name for storage is: ' + _this.auth.userProfile.name);
                var stored_queries = _this.store.get(_this.auth.userProfile.name, angular_persistence__WEBPACK_IMPORTED_MODULE_4__["StorageType"].LOCAL);
                if (stored_queries !== undefined) {
                    console.log(stored_queries);
                    _this.queries = stored_queries;
                }
    ...
    UploadComponent.prototype.getConversion = function (c) {
        var _this = this;
        var cdnl = 'http://cdn.landscapefuelmoisture.bushfirebehaviour.net.au/' + c;
    ...
    UploadComponent.prototype.storeConversions = function () {
        for (var _i = 0, _a = this.conversions; _i < _a.length; _i++) {
            var c = _a[_i];
            if (this.auth.authenticated) {
                this.step = 'step3';
...
var MapboxComponent = /** @class */ (function () {
    ...
    MapboxComponent.prototype.ngAfterViewInit = function () {
        ...
        this.ms.getModels().subscribe(function (result) {
            _this.models = (result.models);
            _this.model_names = _this.getModelNamesOnly();
        }, function (e) {
            console.log(e);
