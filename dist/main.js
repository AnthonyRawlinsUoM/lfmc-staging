...
var MapboxComponent = /** @class */ (function () {
    ...
    MapboxComponent.prototype.makeSourceForModel = function (layer_code) {
        ...
        if (this.selectedDate !== undefined) {
            var sel = moment__WEBPACK_IMPORTED_MODULE_8__(this.selectedDate).toArray();
            time_component = '&time=' + sel[0] + '-' + sel[1] + '-' + sel[2];
        }
        else {
            var s = moment__WEBPACK_IMPORTED_MODULE_8__(this.start).toArray();
...
module.exports = __webpack_require__(/*! /home/arawlins/Documents/lfmc-project/lfmc-staging/src/main.ts */"./src/main.ts");
