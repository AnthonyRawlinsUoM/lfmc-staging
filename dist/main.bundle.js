...
var DatasourcesComponent = (function () {
    ...
    DatasourcesComponent.prototype.getDatasources = function (name) {
        var _this = this;
        return this.sourceserver.getModelDatasources(name).subscribe(function (m) {
            console.log(m);
            _this.datasources = m;
        });
    };
...
var ApiService = (function () {
    function ApiService(http) {
        this.http = http;
        this.apiUrl = 'http://localhost:1880/api';
    }
    // private apiUrl = 'http://api:8002/v1';
    // Deprecated
    ApiService.prototype.getModelDatasources = function (name) {
        return this.http
...
var ModelsService = (function () {
    function ModelsService(http) {
        this.http = http;
        this.modelsUrl = 'http://localhost:1880/api/models';
    }
