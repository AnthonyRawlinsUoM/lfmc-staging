...
let epsg3112 = proj4.defs("EPSG:3112", "+proj=lcc +lat_1=-18 +lat_2=-36 +lat_0=0 +lon_0=134 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
let epsg3857 = proj4.defs("EPSG:3857", "+proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +wktext  +no_defs");
...
export class MapboxComponent implements OnInit, AfterViewInit {
	...
	ngOnInit() {
		...
		map.on('load', function() {
			...
			//     'source': {
			//       'type': 'image',
			//       'url': 'http://localhost:4200/assets/DFMC_20100701.grid.8bit.tif',
			//       'coordinates': [
			//         [108.0000, -10.0000],
			//         [155.0000, -10.0000],
			//         [155.0000, -45.0000],
	...
	public queryLFMCUsingGeoJSON() {
		if (this.drw.getAll()) {
			let bounds = bbox(this.drw.getAll());
